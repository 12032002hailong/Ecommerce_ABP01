...
[DependsOn(
    typeof(TeduEcommerceApplicationTestModule),
...
public class TeduEcommerceEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        var options = new DbContextOptionsBuilder<TeduEcommerceDbContext>()
            .UseSqlite(connection)
            .Options;

        using (var context = new TeduEcommerceDbContext(options))
        {
